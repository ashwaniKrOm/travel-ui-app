...
const Camp =()=>{
    return(
        <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-18 xl:mb-18">
...
export const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampPropsType) => {
    return (
      <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
       <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flex justify-center items-center gap-6">
          ...
          <p className="text-[16px] font-[700] md:text-[20px] text-white">{peopleJoined}</p>
        </div>
       </div>
      </div>
    )
